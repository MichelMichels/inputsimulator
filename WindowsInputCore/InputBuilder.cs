...
namespace WindowsInputCore
{
    ...
    {
        private static readonly List<VirtualKeyCode> _extendedKeys = new List<VirtualKeyCode>
        {
            VirtualKeyCode.MENU,
        ...
        /// </remarks>
        public static bool IsExtendedKey(VirtualKeyCode keyCode) => _extendedKeys.Contains(keyCode);
